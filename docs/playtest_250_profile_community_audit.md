...
- Anonymous /u/domz_test result: Profile unavailable
- Private state leaked handle/bio: no
...
- Direct link worked in link-only mode: yes
- Discovery/listing surface exposed link-only profile: not applicable in current MVP

## Shared reports

- Private-profile report redirected to /r/[slug]: yes
...
- Profile restored to private/private at the end of the audit: yes

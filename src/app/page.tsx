...
function ProductPreview() {
  return (
    <div className="relative">
      <div className="absolute inset-x-10 -top-5 h-16 bg-[#4F8CFF]/12 blur-3xl" />
      <div className="relative rounded-md bg-[#10172A]/94 p-2 shadow-[0_28px_84px_rgba(0,0,0,0.50)] sm:p-3">
        <div className="rounded-md bg-[#0B1020]/96 p-3 shadow-[inset_0_0_0_1px_rgba(248,250,252,0.065)] sm:p-4">
          <div>
          ...
          <div className="mt-3 rounded-md bg-[#11182C]/92 p-4 shadow-[0_16px_42px_rgba(245,200,76,0.08),inset_0_0_0_1px_rgba(245,200,76,0.30)] transition duration-200 hover:-translate-y-0.5 sm:p-5">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2 sm:gap-3">
            {demoMetrics.map((metric) => {
              ...
              return (
                <div
                  key={metric.label}
                  className={`rounded-md p-3 transition duration-200 hover:-translate-y-0.5 ${
                    isWorstMatchup
                      ? "col-span-2 bg-[#251421]/92 shadow-[0_14px_38px_rgba(244,63,94,0.10),inset_0_0_0_1px_rgba(244,63,94,0.28)]"
...
function HeroSignal() {
  return (
    <div className="mt-5 inline-flex max-w-full items-center gap-3 rounded-md bg-[#11182C]/56 px-3 py-2 shadow-[0_12px_30px_rgba(0,0,0,0.16),inset_0_0_0_1px_rgba(248,250,252,0.04)]">
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#0B1020] bg-[radial-gradient(ellipse_at_top,rgba(79,140,255,0.14),transparent_38%),linear-gradient(180deg,#0B1020_0%,#11182C_50%,#0B1020_100%)] text-[#F8FAFC]">
      <header className="px-4 py-4 sm:px-6">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 rounded-md bg-[#0B1020]/38 px-3 py-3 shadow-[inset_0_0_0_1px_rgba(248,250,252,0.045)]">
          <PrizeMapLogo
            variant="app-icon"
            hideTextOnMobile
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/signup"
              className="inline-flex h-10 items-center justify-center rounded-md bg-[#F5C84C] px-3 text-sm font-semibold text-[#0B1020] shadow-[0_14px_34px_rgba(245,200,76,0.20)] transition hover:-translate-y-0.5 hover:bg-[#ffd85f] active:translate-y-0 active:scale-[0.98] sm:px-4"
            >
              Sign up
            </Link>
          </div>
      ...
      <section className="relative px-4 pb-6 pt-3 sm:px-6 sm:pb-9 sm:pt-7">
        ...
        <div className="relative mx-auto grid max-w-6xl gap-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-center">
          <div className="prizemap-fade-in">
            <p className="inline-flex rounded-md bg-[#4F8CFF]/12 px-3 py-1 text-sm font-semibold text-[#F8FAFC] shadow-[inset_0_0_0_1px_rgba(79,140,255,0.22)]">
            ...
            <div className="mt-5">
              <Link
                href="/onboarding"
                className="inline-flex h-12 w-full items-center justify-center rounded-md bg-[#F5C84C] px-6 text-sm font-semibold text-[#0B1020] shadow-[0_18px_44px_rgba(245,200,76,0.30)] transition hover:-translate-y-0.5 hover:bg-[#ffd85f] active:translate-y-0 active:scale-[0.98] sm:w-auto"
              >
                Log your next game
              </Link>
            </div>
      ...
      <section className="px-4 pb-5 sm:px-6 sm:pb-7">
        <div className="mx-auto max-w-6xl rounded-md bg-[#11182C]/42 p-4 shadow-[0_12px_30px_rgba(0,0,0,0.14)] sm:p-5">
      ...
      <section className="px-4 pb-8 sm:px-6 sm:pb-12">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 rounded-md bg-[#11182C]/58 p-4 shadow-[0_14px_36px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(248,250,252,0.04)] sm:p-5 md:flex-row md:items-center md:justify-between">
          <div>
            <h2 className="text-2xl font-semibold tracking-tight text-[#F8FAFC]">
          ...
          <Link
            href="/onboarding"
            className="inline-flex h-12 w-full items-center justify-center rounded-md bg-[#F5C84C] px-4 text-center text-sm font-semibold text-[#0B1020] shadow-[0_18px_44px_rgba(245,200,76,0.28)] transition hover:-translate-y-0.5 hover:bg-[#ffd85f] active:translate-y-0 active:scale-[0.98] sm:px-6 md:w-auto"
          >
            Log your next game
          </Link>
        </div>

...
export const card =
  "rounded-md bg-[#11182C]/76 p-4 shadow-[0_18px_52px_rgba(0,0,0,0.24),inset_0_0_0_1px_rgba(248,250,252,0.05)] sm:p-5";

export const cardLarge =
  "rounded-md bg-[#11182C]/76 p-4 shadow-[0_18px_52px_rgba(0,0,0,0.24),inset_0_0_0_1px_rgba(248,250,252,0.05)] sm:p-6";

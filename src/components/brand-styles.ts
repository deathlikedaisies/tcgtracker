...
export const appShell =
  `min-h-screen w-full max-w-full overflow-x-hidden ${appBackground} px-4 py-3 text-[#F8FAFC] sm:px-6 sm:py-6`;
...
const premiumSurfaceBase =
  "bg-[linear-gradient(180deg,rgba(15,26,45,0.96),rgba(8,17,31,0.90))] shadow-[0_14px_32px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(148,163,184,0.10),inset_0_1px_0_rgba(255,255,255,0.03)] sm:shadow-[0_20px_48px_rgba(0,0,0,0.22),inset_0_0_0_1px_rgba(148,163,184,0.10),inset_0_1px_0_rgba(255,255,255,0.03)] sm:backdrop-blur";
...
export const pageHeader =
  `relative overflow-hidden rounded-[22px] p-3.5 flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between sm:rounded-[26px] sm:p-5 ${premiumSurfaceBase} ${metallicTopEdge} after:pointer-events-none after:absolute after:inset-0 after:hidden after:bg-[radial-gradient(circle_at_top_left,rgba(79,140,255,0.10),transparent_34%),radial-gradient(circle_at_88%_18%,rgba(245,200,76,0.05),transparent_24%)] after:content-[''] sm:after:block`;
...
export const pageTitle = "mt-2 text-[1.75rem] font-bold tracking-tight text-[#F8FAFC] sm:text-4xl";

export const pageCopy = "mt-1.5 max-w-2xl text-sm leading-5 text-[#94A3B8]/78 sm:leading-6";
...
export const card =
  `relative overflow-hidden rounded-[18px] p-3 sm:rounded-[22px] sm:p-4 ${premiumSurfaceBase} before:pointer-events-none before:absolute before:inset-0 before:bg-[${metallicOverlay}] before:opacity-70 before:content-[''] sm:before:opacity-100`;

export const cardLarge =
  `relative overflow-hidden rounded-[22px] p-3.5 sm:rounded-[26px] sm:p-5 ${premiumSurfaceBase} ${metallicTopEdge} before:pointer-events-none before:absolute before:inset-0 before:bg-[${metallicOverlay}] before:opacity-70 before:content-[''] sm:before:opacity-100`;

export const glassPanel =
  "relative overflow-hidden rounded-[22px] bg-[linear-gradient(180deg,rgba(12,20,36,0.88),rgba(8,16,29,0.82))] shadow-[0_12px_28px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(148,163,184,0.10),inset_0_1px_0_rgba(255,255,255,0.03)] sm:rounded-[26px] sm:shadow-[0_16px_40px_rgba(0,0,0,0.22),inset_0_0_0_1px_rgba(148,163,184,0.10),inset_0_1px_0_rgba(255,255,255,0.03)] sm:backdrop-blur before:pointer-events-none before:absolute before:inset-0 before:bg-[linear-gradient(135deg,rgba(255,255,255,0.04),transparent_26%,rgba(79,140,255,0.025)_52%,rgba(245,200,76,0.02)_76%,transparent_88%)] before:opacity-70 before:content-[''] sm:before:opacity-100";

export const glassPanelStrong =
  `relative overflow-hidden rounded-[22px] sm:rounded-[26px] ${premiumSurfaceBase} ${metallicTopEdge} before:pointer-events-none before:absolute before:inset-0 before:bg-[${metallicOverlay}] before:opacity-70 before:content-[''] sm:before:opacity-100 after:pointer-events-none after:absolute after:-left-12 after:top-0 after:hidden after:h-36 after:w-36 after:rounded-full after:bg-[#4F8CFF]/[0.08] after:blur-3xl after:content-[''] sm:after:block`;

export const emptyCard =
  "relative overflow-hidden rounded-[22px] bg-[linear-gradient(180deg,rgba(14,24,42,0.90),rgba(8,17,31,0.84))] p-4 shadow-[0_14px_30px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(148,163,184,0.11),inset_0_1px_0_rgba(255,255,255,0.03)] sm:rounded-[26px] sm:p-8 sm:backdrop-blur";
...
export const input =
  "w-full max-w-full min-w-0 rounded-[14px] bg-[#07111F]/72 px-3 text-[#F8FAFC] shadow-[inset_0_0_0_1px_rgba(148,163,184,0.12)] outline-none transition-colors placeholder:text-[#94A3B8]/52 focus:bg-[#07111F]/86 focus:shadow-[inset_0_0_0_1px_rgba(79,140,255,0.68),0_0_20px_rgba(79,140,255,0.10)]";
...
export const missionHeroCard =
  "relative overflow-hidden rounded-[22px] bg-[linear-gradient(180deg,rgba(15,26,45,0.97),rgba(8,17,31,0.92))] p-3.5 shadow-[0_16px_34px_rgba(0,0,0,0.20),inset_0_0_0_1px_rgba(148,163,184,0.12),inset_0_1px_0_rgba(255,255,255,0.04)] sm:rounded-[26px] sm:p-5 sm:shadow-[0_24px_56px_rgba(0,0,0,0.26),inset_0_0_0_1px_rgba(148,163,184,0.12),inset_0_1px_0_rgba(255,255,255,0.04)] sm:backdrop-blur before:pointer-events-none before:absolute before:inset-0 before:bg-[linear-gradient(135deg,rgba(255,255,255,0.05),transparent_22%,rgba(79,140,255,0.035)_44%,rgba(245,200,76,0.035)_70%,transparent_86%)] before:opacity-70 before:content-[''] sm:before:opacity-100 after:pointer-events-none after:absolute after:-left-10 after:top-0 after:hidden after:h-36 after:w-36 after:rounded-full after:bg-[#4F8CFF]/[0.09] after:blur-3xl after:content-[''] sm:after:block";
...
export const premiumInset =
  "rounded-[18px] bg-[linear-gradient(180deg,rgba(11,18,32,0.74),rgba(8,14,26,0.64))] shadow-[inset_0_0_0_1px_rgba(148,163,184,0.08),inset_0_1px_0_rgba(255,255,255,0.02)] sm:rounded-[22px]";
export const premiumInsetStrong =
  "rounded-[18px] bg-[linear-gradient(180deg,rgba(13,22,38,0.82),rgba(8,14,26,0.72))] shadow-[0_10px_22px_rgba(0,0,0,0.14),inset_0_0_0_1px_rgba(148,163,184,0.10),inset_0_1px_0_rgba(255,255,255,0.03)] sm:rounded-[20px] sm:shadow-[0_14px_34px_rgba(0,0,0,0.18),inset_0_0_0_1px_rgba(148,163,184,0.10),inset_0_1px_0_rgba(255,255,255,0.03)]";
